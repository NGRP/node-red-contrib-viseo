...
Airtable node to get or set data from/to a table.
...
```
npm install node-red-contrib-viseo-airtable
```

### Requirement

Make sure to have "node-red-contrib-viseo-airtable" installed.
In order to use this node, an free Airtable account with an API key is needed.
