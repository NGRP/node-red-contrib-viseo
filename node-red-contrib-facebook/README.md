...
A **bot server** node to connect to a Facebook Messenger chatbot, with different tools like menu, handover, or logs...
...
```
npm install node-red-contrib-viseo-facebook
```
