const { ActivityHandler } = require("../../node-red-contrib-botbuilder-skills/msbot/node_modules/botbuilder");

class VBMBot extends ActivityHandler {
  constructor(node, config, welcomeMessage, sendWelcomeMessage) {
    super();
